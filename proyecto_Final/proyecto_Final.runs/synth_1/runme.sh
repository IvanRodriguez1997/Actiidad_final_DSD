...
HD_PWD='C:/Users/Familia/Documents/GitHub/Actividad_final_DSD/proyecto_Final/proyecto_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xmux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xmux.tcl
